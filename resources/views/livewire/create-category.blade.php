<section class="w-full px-10">
    <h2 class="mt-16 mb-5 text-3xl font-bold">Criar nova categoria</h2>
        ...
        <div class="p-6 bg-white shadow-md rounded-lg mb-10">
            <div class="grid lg:grid-cols-3 lg:gap-6 sm:gap-4 mb-5">
                ...
                <div class="flex flex-row space-x-10 items-end">
                    ...
                    <button class="btn-default bg-blue-600 text-white hover:bg-blue-700 focus:bg-blue-700">Adicionar</button>                
                </div>
            </div>
        </div>
    </form>
